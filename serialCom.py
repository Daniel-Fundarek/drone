...
class SerialCom:
    def __init__(self, tello,run_cycle):
        ...
        self.ser = serial.Serial('COM7', 256000)
        self.line = ''
    ...
    def print_cmd(self):
        print(
            f'right/letf: {self.left_right_command}, fowr/back: {self.forward_backward_command} up/down: {self.up_down_command}, yaw: {self.yaw_vel_command}, command: {self.command}')
